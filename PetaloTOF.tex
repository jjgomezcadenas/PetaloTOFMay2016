...
Rayleigh scattering length &  36.4 cm \\
 \end{tabular}
\caption{Summary of the Monte Carlo setup specifications and the LXe relevant properties used in the simulations.}\label{thetable}
\end{table*}
...
\begin{figure}[!bhtp]
	...
	\caption{\label{fig.crtTPBavg} CRT as a function of the number of photoelectrons used to compute $\Delta t$, for LXe with TPB assuming a 50$\%$ PDE. The blue line is computed for a TPB decay time of 2.2 ns, while the green dotted line is for 3.0 ns.}
\end{figure}
